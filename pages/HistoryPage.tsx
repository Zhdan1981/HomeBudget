...
const HistoryPage: React.FC = () => {
    ...
    return (
        <div className="max-w-md mx-auto">
            <div 
                ref={headerRef}
                className="fixed inset-x-4 max-w-md mx-auto border shadow-lg rounded-2xl backdrop-blur-lg z-20"
                style={{ 
            ...
            <main className="p-4" style={{ paddingTop: headerBottom ? `${headerBottom + 16}px` : '6rem' }}>
                        ...
                        Object.entries(processedTransactions).map(([date, txs]) => {
                            ...
                            return (
                                <div key={date} className="mb-6">
                                    <div className="sticky bg-background z-10 py-2 flex justify-between items-center" style={{ top: headerBottom ? `${headerBottom}px` : '76px' }}>
